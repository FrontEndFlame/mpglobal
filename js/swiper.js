document.addEventListener('DOMContentLoaded', function() {
  ...
  const prevHelpedScrollButton = document.querySelector('.prev-scrll');
  const nextHelpedScrollButton = document.querySelector('.next-scrll');
  ...
  prevHelpedScrollButton.addEventListener('click', () => {
    helpedMainTitle.scrollIntoView({ behavior: 'smooth' });
  });

  // Добавляем обработчик события клика на кнопку swiper-button-next
  nextHelpedScrollButton.addEventListener('click', () => {
    helpedMainTitle.scrollIntoView({ behavior: 'smooth' });
  });
  
  var helpedSliderContainerScroll = document.querySelector('.helped .swiper-wrapper');
  helpedSliderContainerScroll.addEventListener('slideChange', function() {
    helpedMainTitle.scrollIntoView({ behavior: 'smooth' });
    console.log('lol');
  });
