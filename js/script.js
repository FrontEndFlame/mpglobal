...
// var heroTitle = document.getElementById('hero__title');
// var heroScrollDiv = document.getElementById('hero__vertical-scroll');

// var heroWords = document.getElementsByClassName('hero__word');

// var heroContainerHeight = heroTitle.clientHeight;
// var totalHeight = 0;

// for (var i = 0; i < heroWords.length; i++) {
//   totalHeight += heroWords[i].offsetHeight;

//   if (totalHeight > heroContainerHeight) {
//     heroScrollDiv.style.height = totalHeight + 'px';
//     break;
//   }
// }
